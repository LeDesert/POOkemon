...
public class Feu extends Entite{
    private final Enum<Type> m_affiniteForce = Type.AIR;
    private final Enum<Type> m_affiniteFaiblesse = Type.EAU;
     ...
     * constructeur qui permet de creer un pokemon de type Feu avec un nom, des points de vie et une force d'attaque donnée
     */
    public Feu(String nom, int pointDeVieMax, int forceAttaque){
        this.m_nom = nom;
     ...
     * @param nom : nom du pokemon
     * @param pointDeVieMax : point de vie maximum du pokemon
     * constructeur qui permet de creer un pokemon de type Feu avec un nom, des points de vie donnée et une force d'attaque aléatoire
     */
    public Feu(String nom, int pointDeVieMax){
     ...
     * constructeur qui permet de creer un pokemon de type Feu avec un nom et un sort donnée et des points de vie et une force d'attaque aléatoire
     */
    public Feu(String nom, Sort sort){
        Random ran = new Random();
        this.m_nom = nom;
     ...
     * Constructeur de la classe Feu
     * @param nom : nom du pokemon
     * constructeur qui permet de creer un pokemon de type Feu avec un nom donnée et des points de vie et une force d'attaque aléatoire
     */
