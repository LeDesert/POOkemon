...
public class Terre extends Entite{
    private final Enum<Type> m_affiniteForce = Type.EAU;
    private final Enum<Type> m_affiniteFaiblesse = Type.AIR;

    /**
     * @param nom : nom du pokemon
     * @param pointDeVieMax : point de vie maximum du pokemon
     * @param forceAttaque : force d'attaque du pokemon4
     *  constructeur qui permet de creer un pokemon de type Terre avec un nom, des points de vie et une force d'attaque donnée
     */
    public Terre(String nom, int pointDeVieMax, int forceAttaque){
        this.m_nom = nom;
     ...
     * @param nom : nom du pokemon
     * @param pointDeVieMax : point de vie maximum du pokemon
     * constructeur qui permet de creer un pokemon de type Terre avec un nom, des points de vie donnée et une force d'attaque aléatoire
     */
    public Terre(String nom, int pointDeVieMax){
     ...
     * constructeur qui permet de creer un pokemon de type Terre avec un nom et un sort donnée et des points de vie et une force d'attaque aléatoire
     */
    public Terre(String nom, Sort sort){
        Random ran = new Random();
        this.m_nom = nom;
    ...
    /**
     * @param nom : nom du pokemon
     * constructeur qui permet de creer un pokemon de type Terre avec un nom donnée et des points de vie et une force d'attaque aléatoire
     */
    ...
    public boolean attaque(Entite pokemon) {
        ...
        } else if (pokemon.getAffinite().equals(m_affiniteFaiblesse)){
            pokemon.m_pointDeVie = pokemon.m_pointDeVie - (this.m_forceAttaque - 10);
